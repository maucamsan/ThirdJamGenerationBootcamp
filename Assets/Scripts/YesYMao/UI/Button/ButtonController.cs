        ...
        private void OnButtonClick()
        {
            switch(buttonType)
            {
                ...
                case ButtonType.MainMenu:
                    canvasManager.SwitchCanvas(CanvasType.MainMenu);
                    YesYMao.Managers.GameManager.GetInstance().CurrentGamestate = GameState.MainMenu;
                    // UnmountScene
                    break;
                case ButtonType.OptionsMain:
                    canvasManager.SwitchCanvas(CanvasType.OptionsMain);
                    break;
                case ButtonType.MainFromOptions:
                    canvasManager.SwitchCanvas(CanvasType.MainMenu);
                    break;
                case ButtonType.StartGame:
                    canvasManager.SwitchCanvas(CanvasType.GameUI);
                    YesYMao.Managers.GameManager.GetInstance().CurrentGamestate = GameState.GamePlay;
                    break;
                ...
                case ButtonType.Restart:
                    canvasManager.SwitchCanvas(CanvasType.GameUI);
                    YesYMao.Managers.GameManager.GetInstance().CurrentGamestate = GameState.Restart;
                    break;
